...
const statusColors: Record<string, string> = {
  ...
  CANCELLED: 'bg-slate-100 text-[#6B7C86]',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-[#162E3D] rounded-lg border border-[#e8e4de] overflow-hidden">
                  ...
                  <tbody>
                    {data.recentBookings.map(b => (
                      <tr key={b.id} className="border-b border-[#e8e4de] last:border-0 hover:bg-[#faf9f7]">
                        ...
                        <td className="px-4 py-3">
                          <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${statusColors[b.status] || 'bg-slate-100 text-[#6B7C86]'}`}>
                            {b.status}
                          </span>
                        </td>
