...
const inputClass =
  'w-full px-4 py-3 rounded-xl border border-slate-200 bg-[#162E3D] text-[15px] text-[#1a1a1a] placeholder:text-slate-400 focus:border-[#FF6A2A] focus:ring-2 focus:ring-[#FF6A2A]/10 transition-all outline-none'
const selectClass =
  'w-full px-4 py-3 rounded-xl border border-slate-200 bg-[#162E3D] text-[15px] text-[#1a1a1a] focus:border-[#FF6A2A] focus:ring-2 focus:ring-[#FF6A2A]/10 transition-all outline-none appearance-none'
...
export default function MarketplacePage() {
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                filters.features[key]
                  ...
                  : 'bg-slate-100 text-[#9AADB8] hover:bg-slate-200'
              }`}
            >
              {label}
            </button>
  ...
  const ListingCard = ({ listing, featured = false }: { listing: Listing; featured?: boolean }) => (
    <div className={`bg-[#162E3D] rounded-2xl border p-5 sm:p-6 card-hover transition-all ${
      listing.featured || featured ? 'border-[#FF6A2A]/30 shadow-sm shadow-[#FF6A2A]/5' : 'border-slate-200'
    }`}>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {listing.routeStops && listing.routeStops.length > 0 && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-slate-100 text-[#9AADB8] rounded text-[10px] font-semibold">
          ...
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-400 hover:text-[#9AADB8] transition-colors"
            title="Share"
          >
  ...
  return (
    <div>
      ...
      {/* Search header */}
      <div className="bg-[#162E3D] border-b border-slate-200">
          ...
          <div className="flex items-center justify-between mb-4 sm:mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="hidden sm:flex items-center bg-slate-100 rounded-lg p-0.5">
                <button onClick={() => setViewMode('list')} className={`p-2 rounded-md transition-colors ${viewMode === 'list' ? 'bg-[#162E3D] shadow-sm text-[#1a1a1a]' : 'text-slate-400'}`} title="List view">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>
                </button>
                <button onClick={() => setViewMode('calendar')} className={`p-2 rounded-md transition-colors ${viewMode === 'calendar' ? 'bg-[#162E3D] shadow-sm text-[#1a1a1a]' : 'text-slate-400'}`} title="Calendar view">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 bg-[#162E3D] text-sm font-semibold text-[#1a1a1a] hover:bg-slate-50 active:bg-slate-100 transition-colors"
              >
            ...
            <button
              ...
              className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-semibold transition-all ${
                activeTab === 'SPACE_AVAILABLE'
                  ? 'bg-[#162E3D] text-[#1a1a1a] shadow-sm'
                  : 'text-[#6B7C86] hover:text-slate-700'
              }`}
            >
              Available Space
            </button>
            ...
            >
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl border border-[#FF6A2A]/30 bg-[#FF6A2A]/[0.03] text-[15px] text-[#1a1a1a] placeholder:text-slate-400 focus:border-[#FF6A2A] focus:ring-2 focus:ring-[#FF6A2A]/10 transition-all outline-none"
                />
              </div>
              <button
                type="submit"
      ...
      <div className="site-container py-8 sm:py-10">
        ...
        {!loading && (
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <select
                className="px-3 py-2 rounded-xl border border-slate-200 bg-[#162E3D] text-sm text-[#1a1a1a] focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 outline-none"
                value={filters.sort}
        ...
        {viewMode === 'calendar' && !loading && listings.length > 0 && (
          <div className="mb-8">
            <div className="bg-[#162E3D] rounded-2xl border border-slate-200 overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="bg-[#162E3D] rounded-2xl border border-slate-200 p-12 sm:p-16 text-center">
            ...
            {pagination.pages > 1 && (
              <div className="mt-8 flex items-center justify-center gap-1.5">
                <button
                  ...
                  className="p-2.5 rounded-xl border border-slate-200 bg-[#162E3D] text-[#9AADB8] hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                ...
                {pageNumbers().map((p, i) =>
                  typeof p === 'string' ? (
                    ...
                    <button key={p} onClick={() => goToPage(p)} className={`min-w-[40px] h-10 rounded-xl text-sm font-semibold transition-colors ${
                      p === pagination.page ? 'bg-[#1a1a1a] text-white' : 'border border-slate-200 bg-[#162E3D] text-[#9AADB8] hover:bg-slate-50'
                    }`}>{p}</button>
                  )
                )}
                <button
          ...
          <div className="relative bg-[#162E3D] w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-slide-up sm:animate-fade-up">
            ...
            {bookingSuccess ? (
              ...
              <form onSubmit={submitBooking} className="p-5 sm:p-6 space-y-4">
                {bookingError && (
                  <div className="px-4 py-3 rounded-xl bg-red-500/10 border border-red-100">
                ...
                <div className="border border-slate-200 rounded-xl p-4">
                    ...
                    <div className="space-y-3 mb-3">
                      ...
                      {Object.entries(PACKAGE_PRESETS).filter(([, p]) => p.group === group).map(([key, preset]) => (
                        <button
                          ...
                          className="text-left p-2 rounded-lg border border-slate-200 hover:border-[#FF6A2A] hover:bg-[#FF6A2A]/5 transition-colors"
                        >
                  ...
                  {packages.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-xs text-[#6B7C86] pt-1 border-t border-slate-200">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <label key={opt.value} className={`flex flex-col items-center p-3 rounded-xl border-2 cursor-pointer transition-all text-center ${bookingForm.routeDirection === opt.value ? 'border-[#FF6A2A] bg-[#FF6A2A]/10/50' : 'border-slate-200'}`}>
            ...
            {alertSuccess ? (
              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-slate-50 rounded-xl p-3 text-xs text-[#9AADB8] space-y-1">
