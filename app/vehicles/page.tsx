                ...
                {editingId === v.id ? (
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button onClick={() => handleDelete(v.id)} className="px-3 py-1.5 border border-[#B23A2E]/30 rounded text-xs font-medium text-[var(--c-error)] hover:bg-[#B23A2E]/10">Delete</button>
                    </div>
                  </div>
                )}
              </div>
