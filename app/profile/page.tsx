  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-extrabold text-navy-900 tracking-tight mb-8">Profile & Settings</h1>
              ...
              <div className="flex items-center gap-3 mt-1">
                {rating.count > 0 && (
                  <div className="flex items-center gap-1">
                    {[1,2,3,4,5].map(s => <svg key={s} className={`w-3.5 h-3.5 ${s <= Math.round(rating.average) ? 'text-gold-500' : 'text-slate-200'}`} fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>)}
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={label as string}>
                    ...
                    <dd className="text-sm font-medium text-navy-900 mt-0.5">{value || '-'}</dd>
                  </div>
                ))}
              </dl>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-navy-900">Email Notifications</div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-navy-900">SMS Notifications</div>
