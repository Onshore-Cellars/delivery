...
export default function TermsPage() {
  return (
    <div className="page-container page-container-narrow py-10">
      ...
      <h1 className="text-2xl sm:text-3xl font-semibold text-[#F7F9FB] tracking-[-0.02em] mb-2" style={{ fontFamily: 'var(--font-display)' }}>Terms of Service</h1>
      <p className="text-xs text-[#6B7C86] mb-8">Last updated: 20 March 2026</p>

      <div className="bg-[#162E3D] rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-white/[0.08] p-6 sm:p-10 space-y-6 text-sm text-[#4a4a4a] leading-relaxed">
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2 mt-0">1. About Onshore Deliver</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">2. User Accounts</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">3. Carrier Obligations</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">4. Shipper Obligations</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">5. Bookings & Payments</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">6. Cancellation Policy</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">7. Platform Right to Cancel</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">8. Communication &amp; Contact Details</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">9. Liability</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">10. Prohibited Items</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">11. Proof of Delivery</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">12. Reviews & Ratings</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">13. Intellectual Property</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">14. Termination</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">15. Governing Law</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[#F7F9FB] mb-2">16. Contact</h2>
          <p>For questions about these terms, contact us at <a href="mailto:legal@onshore.delivery" className="text-[#FF6A2A] hover:underline">legal@onshore.delivery</a>.</p>
        </section>
      </div>
    </div>
  )
