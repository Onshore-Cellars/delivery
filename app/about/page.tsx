...
export default function AboutPage() {
  return (
    <div className="page-container narrow">
        ...
        {/* The Problem */}
        <div className="bg-[#162E3D] rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.3)] border border-white/10 p-6 sm:p-10 mb-8 sm:mb-10">
        ...
        {/* Two-Way Routes */}
        <div className="bg-[#0B1F2A] rounded-2xl border border-white/10 p-6 sm:p-10 mb-8 sm:mb-10">
        ...
        <div className="bg-[#162E3D] rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.3)] border border-white/10 p-6 sm:p-10 mb-8 sm:mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.role} className="p-4 rounded-xl bg-[#0B1F2A] border border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
          {[
            ...
            <div key={item.label} className="bg-[#162E3D] rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.3)] border border-white/10 p-6 sm:p-8 text-center hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] transition-shadow">
