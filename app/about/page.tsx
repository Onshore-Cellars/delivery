...
export default function AboutPage() {
  return (
    <div className="page-container narrow">
        ...
        <h1 className="text-2xl sm:text-3xl font-semibold text-[#F7F9FB] tracking-[-0.02em] mb-8 sm:mb-10">About Onshore Deliver</h1>

        {/* The Problem */}
        <div className="bg-[#162E3D] rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-white/[0.08] p-6 sm:p-10 mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-xl font-bold text-[#F7F9FB] mb-4">The Problem We Solve</h2>
        ...
        {/* Two-Way Routes */}
        <div className="bg-[#102535] rounded-2xl border border-white/[0.08] p-6 sm:p-10 mb-8 sm:mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-[#F7F9FB]">Two-Way Routes &mdash; No Empty Returns</h2>
          </div>
          <p className="text-sm sm:text-base text-[#9AADB8] leading-relaxed mb-4">
        ...
        {/* Who We Serve */}
        <div className="bg-[#162E3D] rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-white/[0.08] p-6 sm:p-10 mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-xl font-bold text-[#F7F9FB] mb-4">Built for the People Who Run Yachts</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.role} className="p-4 rounded-xl bg-[#102535] border border-white/[0.08]">
                <h3 className="font-semibold text-[#F7F9FB] text-sm mb-1">{item.role}</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
          {[
            ...
            <div key={item.label} className="bg-[#162E3D] rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-white/[0.08] p-6 sm:p-8 text-center hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] transition-shadow">
              <div className="text-3xl sm:text-4xl font-semibold text-[#F7F9FB] tracking-[-0.02em]">{item.stat}</div>
        ...
        <div className="bg-[#162E3D] rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-white/[0.08] p-6 sm:p-10 mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-xl font-bold text-[#F7F9FB] mb-6">How It Works</h2>
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-[#102535] flex items-center justify-center flex-shrink-0">
                <span className="text-sm font-bold text-[#F7F9FB]">1</span>
              </div>
              <div>
                <h3 className="font-semibold text-[#F7F9FB]">Carriers List Spare Space &mdash; Both Ways</h3>
            ...
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-[#102535] flex items-center justify-center flex-shrink-0">
                <span className="text-sm font-bold text-[#F7F9FB]">2</span>
              </div>
              <div>
                <h3 className="font-semibold text-[#F7F9FB]">Crew, Vendors &amp; Managers Book Space</h3>
            ...
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-[#102535] flex items-center justify-center flex-shrink-0">
                <span className="text-sm font-bold text-[#F7F9FB]">3</span>
              </div>
              <div>
                <h3 className="font-semibold text-[#F7F9FB]">Track Live, Delivered Dockside</h3>
        ...
        {/* Platform Features */}
        <div className="bg-[#162E3D] rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-white/[0.08] p-6 sm:p-10 mb-8 sm:mb-10">
          <h2 className="text-lg sm:text-xl font-bold text-[#F7F9FB] mb-6">Platform Features</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.feat} className="flex items-start gap-3 p-3 rounded-lg">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-[#F7F9FB]">{item.feat}</h3>
        ...
        <div className="bg-[#1d1d1f] rounded-2xl p-6 sm:p-10 text-center relative overflow-hidden">
          ...
          <p className="text-sm sm:text-base text-[#6B7C86] mb-6">Join crew, vendors, fleet managers, and carriers who are making maritime logistics smarter.</p>
