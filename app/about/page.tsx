          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Driving to a port or marina? List your spare capacity on the outbound run and on the return. Set pricing for each direction.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-[#f5f5f7] flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Browse available routes, book capacity for supplies going to the yacht or items coming back. Request a quote for custom loads.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-full bg-[#f5f5f7] flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Drivers start their route from the app. You see live position, ETA, and get SMS updates. Delivery confirmed with signature and photo at the berth.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.feat} className="flex items-start gap-3 p-3 rounded-lg">
                <svg className="w-5 h-5 text-[#C6904D] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
