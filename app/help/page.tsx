...
export default function HelpPage() {
  ...
  return (
    <div className="page-container narrow">
      <div className="mb-8">
        <p className="text-[11px] font-semibold text-[#C6904D] uppercase tracking-[0.15em] mb-1">Support</p>
        <h1 className="text-xl sm:text-2xl font-semibold text-[#1a1a1a] tracking-[-0.02em]">Help & Support</h1>
        <p className="mt-1.5 text-sm text-slate-500">Find answers to common questions or chat with our AI assistant</p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#e8e4de] overflow-hidden flex flex-col" style={{ height: '480px' }}>
          {/* Chat messages */}
