  ...
  try {
    ...
    const user = await prisma.user.findUnique({
      ...
      select: {
        ...
        notifyBookings: true, notifyPayments: true, notifyBids: true, notifyMessages: true, notifyMarketing: true, weeklyDigest: true,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const allowedFields = [
      ...
      'notifyBookings', 'notifyPayments', 'notifyBids', 'notifyMessages', 'notifyMarketing', 'weeklyDigest',
      'canCarry', 'canShip',
