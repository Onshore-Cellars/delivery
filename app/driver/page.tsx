...
export default function DriverPage() {
  ...
  return (
    <div className="page-container narrow">
      ...
      {error && (
        <div className="px-4 py-3 rounded-lg bg-red-500/10 border border-red-100 mb-4 flex items-center justify-between">
      ...
      {/* Tracking Status */}
      {tracking && position && (
        <div className="bg-[#9ED36A]/10 border border-green-200 rounded-2xl p-4 mb-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-semibold text-red-400 hover:text-red-800 px-3 py-1.5 rounded-lg hover:bg-red-500/100/10 transition-colors"
            >
              Stop Tracking
            </button>
          </div>
      ...
      {loading ? (
        ...
        <div className="bg-[#162E3D] rounded-2xl border border-slate-200 p-10 text-center">
        ...
        <div className="space-y-6">
          ...
          {!hasActiveTracking && uniqueListings.map(listingId => {
            ...
            return (
              <div key={listingId} className="bg-[#162E3D] rounded-2xl border border-slate-200 p-5">
          ...
          <div className="space-y-3">
            ...
            {stops.map((stop, index) => (
              <div key={stop.id} className="bg-[#162E3D] rounded-2xl border border-slate-200 p-4 sm:p-5">
