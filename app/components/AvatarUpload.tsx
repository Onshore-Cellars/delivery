  ...
  return (
    <div className="relative group">
      ...
      <button
        ...
        className="absolute -bottom-1 -right-1 w-7 h-7 rounded-full bg-[#C6904D] text-white flex items-center justify-center shadow-md hover:bg-[#b07d3f] transition-colors"
      >
