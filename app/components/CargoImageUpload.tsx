...
export default function CargoImageUpload({ images, onChange, maxImages = 5 }: CargoImageUploadProps) {
  ...
  return (
    <div>
      <div className="flex flex-wrap gap-3">
        ...
        {images.length < maxImages && (
          <button
            ...
            disabled={uploading}
            className="w-20 h-20 rounded-xl border-2 border-dashed border-white/[0.1] flex flex-col items-center justify-center text-[#6B7C86] hover:border-[#C6904D] hover:text-[#FF6A2A] transition-colors disabled:opacity-50"
          >
            {uploading ? (
      ...
      <p className="text-[10px] text-[#6B7C86] mt-1.5">
