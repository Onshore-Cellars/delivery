      ...
      <div className="flex flex-wrap gap-3">
        ...
        {images.length < maxImages && (
          <button
            ...
            disabled={uploading}
            className="w-20 h-20 rounded-xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400 hover:border-[#C6904D] hover:text-[#C6904D] transition-colors disabled:opacity-50"
          >
            {uploading ? (
