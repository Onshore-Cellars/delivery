              ...
              {user ? (
                <>
                  ...
                  <div className="relative">
                    ...
                    {moreMenuOpen && (
                      <div className="absolute top-full right-0 mt-1 w-48 bg-[var(--c-surface)] rounded-lg shadow-lg border border-black/[0.08] py-1 z-50">
                        ...
                        {user.canCarry && (
                          <>
                            <Link href="/earnings" className="block px-4 py-2.5 text-sm text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06] hover:no-underline">Earnings</Link>
                            <Link href="/vehicles" className="block px-4 py-2.5 text-sm text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06] hover:no-underline">My Vehicles</Link>
                          </>
                        )}
                      </div>
                    )}
                  ...
                  <Link href="/notifications" className={`relative p-2 rounded transition-colors ${isTransparentMode ? 'hover:bg-[var(--c-surface)]/10' : 'hover:bg-[var(--c-surface)]/[0.06]'}`} title="Notifications" aria-label="Notifications">
                    ...
                    {unreadNotifs > 0 && (
                      <span className="absolute top-0.5 right-0.5 min-w-[18px] h-[18px] rounded-full bg-[#B23A2E] text-white text-[10px] font-bold flex items-center justify-center px-1">
                  ...
                  <button
                    onClick={logout}
                    className="px-3 py-2 text-xs font-medium text-[var(--c-text-3)] hover:text-[var(--c-error)] hover:bg-[#B23A2E]/10 rounded transition-colors"
                    title="Sign out"
                    aria-label="Sign out"
                  >
            ...
            <div className="flex md:hidden items-center gap-2">
              {user && unreadMessages > 0 && (
                <Link href="/messages" className={`relative p-2 rounded ${isTransparentMode ? 'hover:bg-[var(--c-surface)]/10' : 'hover:bg-[var(--c-surface)]/[0.06]'}`} aria-label="Messages">
                  ...
                  <span className="absolute top-0.5 right-0.5 min-w-[16px] h-[16px] rounded-full bg-[#B23A2E] text-white text-[9px] font-bold flex items-center justify-center">
                    {unreadMessages > 9 ? '9+' : unreadMessages}
                  </span>
                </Link>
              )}
        ...
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          <div className="absolute top-0 right-0 w-full max-w-[320px] h-full bg-[var(--c-canvas-2)] shadow-2xl animate-slide-in-right flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
              <Link href="/marketplace" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/marketplace') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                <TabIcon icon="search" className={isActive('/marketplace') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'} />
                Marketplace
              </Link>
              <Link href="/get-quotes" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/get-quotes') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                <svg className={`w-5 h-5 ${isActive('/get-quotes') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                Get Quotes
              </Link>
              <Link href="/tracking" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/tracking') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                <TabIcon icon="location" className={isActive('/tracking') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'} />
                Track Shipment
              </Link>
              <Link href="/community" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/community') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                <svg className={`w-5 h-5 ${isActive('/community') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                Community
              </Link>
              ...
              {user ? (
                <>
                  <div className="pt-4 pb-2 px-4">
                    <p className="text-[11px] font-semibold text-[var(--c-text-3)] uppercase tracking-widest">Account</p>
                  </div>
                  <Link href="/dashboard" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/dashboard') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <TabIcon icon="grid" className={isActive('/dashboard') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'} />
                    Dashboard
                  </Link>
                  <Link href="/messages" onClick={close} className={`flex items-center justify-between px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/messages') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <span className="flex items-center gap-3.5">
                      <TabIcon icon="chat" className={isActive('/messages') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'} />
                      Messages
                    </span>
                    {unreadMessages > 0 && (
                      <span className="min-w-[22px] h-[22px] rounded-full bg-[#B23A2E] text-white text-[11px] font-bold flex items-center justify-center px-1.5">
                        {unreadMessages > 9 ? '9+' : unreadMessages}
                      </span>
                    )}
                  </Link>
                  <Link href="/profile" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/profile') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <TabIcon icon="user" className={isActive('/profile') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'} />
                    Profile
                  </Link>
                  <Link href="/quotes" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/quotes') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <svg className={`w-5 h-5 ${isActive('/quotes') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                    Quotes
                  </Link>
                  <Link href="/notifications" onClick={close} className={`flex items-center justify-between px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/notifications') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <span className="flex items-center gap-3.5">
                      <svg className={`w-5 h-5 ${isActive('/notifications') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
                      Notifications
                    </span>
                    {unreadNotifs > 0 && (
                      <span className="min-w-[22px] h-[22px] rounded-full bg-[#B23A2E] text-white text-[11px] font-bold flex items-center justify-center px-1.5">
                  ...
                  {user.canCarry && (
                    <>
                    <Link href="/listings/create" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/listings/create') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                      <svg className={`w-5 h-5 ${isActive('/listings/create') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 4v16m8-8H4" />
                      </svg>
                      List Space
                    </Link>
                    <Link href="/vehicles" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/vehicles') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                      <svg className={`w-5 h-5 ${isActive('/vehicles') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 7h8m-8 4h4m5 4H5a2 2 0 01-2-2V7a2 2 0 012-2h14a2 2 0 012 2v6a2 2 0 01-2 2zm-3 0v2a2 2 0 01-2 2H9a2 2 0 01-2-2v-2" /></svg>
                      My Vehicles
                    </Link>
                    <Link href="/earnings" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/earnings') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                      <svg className={`w-5 h-5 ${isActive('/earnings') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                      Earnings
                    </Link>
                    </>
                  )}
                  <Link href="/disputes" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/disputes') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <svg className={`w-5 h-5 ${isActive('/disputes') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z" /></svg>
                    Disputes
                  </Link>
                  <Link href="/analytics" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/analytics') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <svg className={`w-5 h-5 ${isActive('/analytics') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                    Analytics
                  </Link>
                  <Link href="/insurance" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/insurance') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                    <svg className={`w-5 h-5 ${isActive('/insurance') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                    Insurance
                  </Link>
                  {user.role === 'ADMIN' && (
                    <Link href="/admin" onClick={close} className={`flex items-center gap-3.5 px-4 py-3.5 rounded text-[15px] font-medium transition-colors hover:no-underline ${isActive('/admin') ? 'bg-[var(--c-brand)]/15 text-[var(--c-info)]' : 'text-[var(--c-ink)] hover:bg-[var(--c-surface)]/[0.06]'}`}>
                      <svg className={`w-5 h-5 ${isActive('/admin') ? 'text-[var(--c-info)]' : 'text-[var(--c-text-3)]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {user ? (
                <div>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 text-sm font-semibold text-[var(--c-error)] rounded hover:bg-[#B23A2E]/10 transition-colors text-left"
                  >
                    Sign Out
                  </button>
                </div>
              ...
              >
                <div className="relative w-5 h-5 flex items-center justify-center">
                  ...
                  {'badge' in tab && tab.badge && tab.badge > 0 && (
                    <span className="absolute -top-1 -right-2.5 min-w-[14px] h-[14px] rounded-full bg-[#B23A2E] text-white text-[8px] font-bold flex items-center justify-center leading-none">
