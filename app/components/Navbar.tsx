            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              {user ? (
                <>
                  ...
                  {/* Notifications */}
                  <Link href="/dashboard" className={`relative p-2 rounded transition-colors ${isTransparentMode ? 'hover:bg-white/10' : 'hover:bg-slate-50'}`} title="Notifications" aria-label="Notifications">
