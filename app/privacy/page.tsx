    ...
    <div className="page-container page-container-narrow py-10">
      ...
      <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#e8e4de] p-6 sm:p-10 space-y-6 text-sm text-[#4a4a4a] leading-relaxed">
        <section>
          ...
          <p>Onshore Deliver is a delivery logistics marketplace operated from France. We are the data controller for personal data collected through this platform. For GDPR purposes, our contact address is <a href="mailto:privacy@onshore.delivery" className="text-[#C6904D] hover:underline">privacy@onshore.delivery</a>.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">To exercise these rights, email <a href="mailto:privacy@onshore.delivery" className="text-[#C6904D] hover:underline">privacy@onshore.delivery</a>. We will respond within 30 days.</p>
        </section>
