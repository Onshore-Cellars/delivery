  ...
  return (
    <div className="page-container max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-slate-100/80 p-6 sm:p-10 prose prose-slate max-w-none">
          <h2 className="text-lg font-bold text-[#1d1d1f] mt-0">1. Information We Collect</h2>
          ...
          <h2 className="text-lg font-bold text-[#1d1d1f]">2. How We Use Your Information</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#1d1d1f]">3. Information Sharing</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#1d1d1f]">4. Data Security</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#1d1d1f]">5. Your Rights</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
            ...
            to processing. Contact us at privacy@onshore.delivery to exercise these rights.
          </p>

          <h2 className="text-lg font-bold text-[#1d1d1f]">6. Cookies</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#1d1d1f]">7. Data Retention</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#1d1d1f]">8. Contact</h2>
          <p className="text-slate-600 text-sm leading-relaxed">
            For privacy concerns, contact our Data Protection Officer at privacy@onshore.delivery.
          </p>
        </div>
      </div>
  )
