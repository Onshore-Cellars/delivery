...
export default function PrivacyPage() {
  return (
    <div className="page-container page-container-narrow py-10">
      <p className="text-[11px] font-semibold text-[var(--c-accent)] uppercase tracking-[0.15em] mb-1.5">Legal</p>
      <h1 className="text-2xl sm:text-3xl font-semibold text-[var(--c-ink)] tracking-[-0.02em] mb-2" style={{ fontFamily: 'var(--font-display)' }}>Privacy Policy</h1>
      <p className="text-xs text-[var(--c-text-2)] mb-8">Last updated: 20 March 2026</p>

      <div className="bg-[var(--c-surface)] rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.3)] border border-black/10 p-6 sm:p-10 space-y-6 text-sm text-[var(--c-text-2)] leading-relaxed">
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2 mt-0">1. Who We Are</h2>
          <p>Onshore Deliver is a delivery logistics marketplace operated from France. We are the data controller for personal data collected through this platform. For GDPR purposes, our contact address is <a href="mailto:privacy@onshore.delivery" className="text-[var(--c-accent)] hover:underline">privacy@onshore.delivery</a>.</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">2. Data We Collect</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">3. Legal Basis for Processing (GDPR)</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">4. How We Use Your Data</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">5. Data Sharing</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">6. Data Retention</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">7. Your Rights (GDPR)</h2>
          ...
          <p className="mt-2">To exercise these rights, email <a href="mailto:privacy@onshore.delivery" className="text-[var(--c-accent)] hover:underline">privacy@onshore.delivery</a>. We will respond within 30 days.</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">8. Cookies</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">9. Security</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">10. International Transfers</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">11. Children</h2>
          <p>Our services are not intended for individuals under 18. We do not knowingly collect data from minors.</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">12. Changes to This Policy</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--c-ink)] mb-2">13. Supervisory Authority</h2>
